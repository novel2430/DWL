...
static const float bordercolor[] = COLOR(0x3f3f36ff);
...
static const char *browsercmd[] = {"app.zen_browser.zen", NULL};
...
static const Key keys[] = {
    ...
    // { MODKEY,                    XKB_KEY_r,          regions, SHCMD("grim -g
    // \"$(slurp)\"") },
    ...
    {MODKEY | WLR_MODIFIER_CTRL, XKB_KEY_j, remembercycletag, {.i = +1}},
    ...
    // { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_parenright, tag,            {.ui =
    // ~0} },
    ...
    // tagmon,         {.i = WLR_DIRECTION_LEFT} }, { MODKEY|WLR_MODIFIER_SHIFT,
